...
(function() {
  ...
  BaseTool = (function() {
    ...
    function BaseTool(opts) {
      ...
      this.createDimensions('uid');
      if (typeof this.selectedKey !== 'undefined') {
        this.createDimensions(this.selectedKey);
      }
    ...
    BaseTool.prototype.selectKey = function(key) {
      delete this.dimensions[this.selectedKey];
      this.createDimensions(key);
      this.selectedKey = key;
      this.selectKeyCb(key);
      return this.start();
    };

    BaseTool.prototype.createDimensions = function(keys) {
      var dimKeys, key, _i, _len, _results;
      dimKeys = [];
      if (!_.isArray(keys)) {
        dimKeys.push(keys);
      } else {
      ...
      _results = [];
      for (_i = 0, _len = dimKeys.length; _i < _len; _i++) {
        key = dimKeys[_i];
